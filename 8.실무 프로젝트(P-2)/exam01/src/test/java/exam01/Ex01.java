...
public class Ex01 {
    ...
    void test1() {
        ...
        try (Connection conn = DriverManager.getConnection(url,user,password);
            ...
            String sql = "INSERT INTO MEMBER (USER_NO, USER_ID, USER_PW, USER_NM, MOBILE) VALUES (SEQ_MEMBER.NEXTVAL, 'USER02', '123456', '사용자02', '010000000')";
    ...
    void test2() {
        ...
        try(Connection conn = DriverManager.getConnection(url, user, password);
            ...
            while (rs.next()) {
                ...
                System.out.printf("USER_NO:%d, USER_ID:%s%n,USER_PW:%s, USER_NM:%s, REG_DT:%s%n",userNo,userId,userPw,userNm,mobile);
            }
