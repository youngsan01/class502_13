...
public class JoinValidator implements Validator<RequestJoin>, RequiredValidator, EmailValidator {
    ...
    public void check(RequestJoin form) {
        ...
        checkRequired(email, new BadRequestException("이메일을 입력하십쇼."));
        checkRequired(password, new BadRequestException("비밀번호를 입력하십쇼."));
        checkRequired(confirmPassword, new BadRequestException("비밀번호를 확인하십쇼."));
        checkRequired(userName, new BadRequestException("회원명을 입력하십쇼."));
